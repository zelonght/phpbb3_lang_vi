...
$lang = array_merge($lang, array(
	...
	'CURRENT_CHANGE_PASSWORD_EXPLAIN' => 'Để thay đổi mật khẩu, địa chỉ email, hay tên đăng nhập, bạn phải xác nhận mật khẩu hiện tại của bạn.',
	...
	'INVALID_EMOJIS_USERNAME'	=> 'Tên thành viên bạn vừa nhập có những ký tự không được phép sử dụng (Emoji).',
	...
	'MESSAGE_REPORTED_MESSAGE'		=> 'Tin nhắn đã báo cáo',
	...
	'NO_AUTH_PRINT_MESSAGE'			=> 'Bạn không được phép in tin nhắn.',
	...
	'EMAIL_NOT_UNIQUE'			=> 'Địa chỉ email bạn vừa nhập được sử dụng bởi nhiều thành viên. Bạn phải xác định tên thành viên.',
	...
	'NO_RESET_TOKEN'			=> 'Bạn chưa cung cấp mã xác nhận thay đổi mật khẩu.',
	...
	'PASSWORD_RESET'			=> 'Mật khẩu của bạn đã được thay đổi thành công.',
	'PASSWORD_RESET_LINK_SENT'	=> 'Nếu tài khoản của bạn tồn tại, một đường dẫn để thay đổi mật khẩu đã được gửi đến email mà bạn dùng để đăng ký. Nếu bạn không nhận được email, có thể tài bản của bạn đã bị khóa, chưa kích hoạt, bạn yêu cầu thay đổi mật khẩu nhiều lần trong khoảng thời gian quá ngắn, hoặc bạn không được phép thay đổi mật khẩu. Liên lạc với quản trị viên nếu bạn gặp bất kỳ tình huống nào vừa nêu. Bạn cũng nên kiểm tra trong hộp thư rác của mình.',
	...
	'OAUTH_REGISTRATION'					=> 'Đăng ký bằng dịch vụ ngoại vi',
	...
	'RESET_TOKEN_EXPIRED_OR_INVALID'	=> 'Mã xác nhận thay đổi mật khẩu bạn vừa nhập không tồn tại hoặc đã hết hạn.',
	...
	'RULE_ADDED'						=> 'Quy định đã được thêm vào thành công.',
	'RULE_ALREADY_DEFINED'				=> 'Quy định này đã được xác định rồi.',
